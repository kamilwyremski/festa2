...
<body>
	<div id="top" class="container-fluid">
		<p class="text-right small text-white mb-0">FESTA 2</p>
	</div>
	<nav class="navbar fixed-top navbar-expand-md navbar-light" id="menu_box">
		...
		<div class="collapse navbar-collapse" id="menu">
			<ul class="navbar-nav ml-auto">
				...
				{% if settings.enable_blog %}<li class="nav-item {% if controller=='blogs' %}active{% endif %}"><a href="{{ path('blog') }}" title="{{ 'Blog'|trans }}" class="nav-link">{{ 'Blog'|trans }}</a></li>{% endif %}
				{% if user.id %}
