				...
				if(flag){
					...
					$.ajax({
						...
						success: function(data){
							if(data){
								if(data.status){
									$("#preview_photos").append('<div class="img-thumbnail"><img src="upload/photos/'+data['thumb']+'" alt="'+data['url']+'"><br><button class="btn btn-link remove_photo text-danger" title="'+data['remove_title']+'">'+data['remove']+'</button><input type="hidden" name="photos[]" value="'+data['id']+'"></div>');
								}else{
