...
('code_style', ''),
('currency', 'zł'),
('days_before_refresh', '14'),
('days_default', '180'),
('days_refresh', '180'),
('days_to_remove', '180'),
('description', 'Festa2 to skrypt strony internetowej umożliwiający stworzenie swojej własny bazy z ogłoszeniami noclegowymi'),
('dotpay_currency', 'PLN'),
('dotpay_id', ''),
('dotpay_pin', ''),
('dotpay_test_mode', '0'),
...
('footer_bottom', '<p class=\"mb-2\">Strona pokazowa skryptu bazy nocleg&oacute;w&nbsp;FESTA2</p>\r\n<p class=\"small\">Festa 2.3.4 &copy; Project 2019 - 2023 by <a href=\"https://itworksbetter.net\" target=\"_blank\" title=\"Creating websites\">IT Works Better</a></p>'),
...
('index_page', '<h3 style=\"text-align: center;\">WITAJ W SKRYPCIE BAZY NOCLEGÓW FESTA2</h3>\r\n\r\n<p style=\"text-align: center;\">Prezentujemy Ci jeden z najlepszych skrypt&oacute;w dla strony internetowej z bazą nocleg&oacute;w! Skrypt umożliwia stworzenie strony z bazą nocleg&oacute;w w każdej kategorii, lokalnej, og&oacute;lnopolskiej albo międzynarodowej. Dostępnych jest bardzo wiele opcji konfiguracyjnych, dzięki czemu można dostosować go do indywidualnych potrzeb.&nbsp;</p>\r\n'),
('keywords', 'noclegi, nocleg, skrypt noclegowy, skrypt bazy noclegów'),
('lang', 'pl'),
('limit_page', '10'),
('limit_page_index', '12'),
('limit_similar', '6'),
('login_page', '<h2>Skrypt bazy nocleg&oacute;w Festa2</h2>\r\n\r\n<h4>&nbsp;</h4>\r\n\r\n<h4>Zakładając konto w naszym serwisie&nbsp;uzyskasz dostęp do:</h4>\r\n\r\n<ul>\r\n	<li>Zarządzania w łatwy spos&oacute;b dodanymi ogłoszeniami</li>\r\n	<li>Listy&nbsp;wszystkich swoich ogłoszeń w jednym miejscu</li>\r\n	<li>Możliwości&nbsp;dodawania&nbsp;ogłoszeń&nbsp;do schowka i zarządzanie nimi</li>\r\n	<li>Podglądu danych os&oacute;b wystawiających ogłoszenie</li>\r\n	<li>Możliwości dodania awatara do swojego konta</li>\r\n</ul>\r\n\r\n<p>&nbsp;</p>\r\n'),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `register_fb` int(1) NOT NULL DEFAULT '0',
