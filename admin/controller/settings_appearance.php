	...
	if(isset($_POST['action']) and $_POST['action']=='save_settings_appearance' and !empty($_POST['template']) and checkToken('admin_save_settings_appearance')){
		...
		if(!_ADMIN_TEST_MODE_){
			settings::saveArrays(
				...
				['search_box_category','search_box_address','search_box_distance','search_box_keywords','search_box_state','search_box_location','search_box_options','search_box_photos','search_box_promoted','show_contact_form_classified','show_contact_form_profile','show_breadcrumbs','index_box_subcategories','show_number_classifieds_in_categories','rodo_alert']
			);
		}
