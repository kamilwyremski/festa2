...
if($admin->is_logged()){
    ...
    settings::saveArrays(
			...
			['social_facebook','social_pinterest','social_twitter','social_wykop','facebook_side_panel','allow_comments_fb_profile','allow_comments_fb_blog','facebook_login','google_login']
		);
		getSettings();
